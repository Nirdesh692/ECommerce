    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShippingsStatus", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryTime = table.Column<TimeOnly>(type: "time", nullable: true),
                    Address = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ShippingStatusId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Shippings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Shippings_ShippingsStatus_ShippingStatusId",
                        column: x => x.ShippingStatusId,
                        principalTable: "ShippingsStatus",
                        principalColumn: "Id");
                });
